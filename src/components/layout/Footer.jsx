    ...
    <footer className="site-footer">
      <div className="container">
        <div className="row g-4">
          ...
          <div className="col-lg-4">
            ...
            <div className="mb-3">
              ...
              <div className="text-muted small">{company?.address_bd || 'House # 123, Road # 5, Block # F, Banani, Dhaka-1213, Bangladesh'}</div>
              <div className="text-gold small mt-1">
                <i className="bi bi-telephone me-1"></i> {company?.phone_bd || '+880 01894-XXXXXX'}
              </div>
            </div>
            ...
            <div className="mb-3">
              ...
              <div className="text-muted small">{company?.address_sa || 'King Fahd Road, Olaya, Riyadh, Kingdom of Saudi Arabia'}</div>
              <div className="text-gold small mt-1">
                <i className="bi bi-telephone me-1"></i> {company?.phone_sa || '+966 5X XXX XXXX'}
              </div>
            </div>
            <div>
              <div className="text-muted small">
                <i className="bi bi-envelope me-1"></i> {company?.email || 'info@eminentint.com'}
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="footer-bottom d-flex flex-column flex-md-row justify-content-between align-items-center">
          <div>&copy; {new Date().getFullYear()} Eminent International. All Rights Reserved.</div>
